  ...
  return (
    <section className="roadmap" id="roadmap">
      ...
      <p className="roadmap-text">
        ...
        Onchain Proof),
        <br /> so you will get a cool nipple that with the power of the
        community and NFN(Non-Fungiblenomics)retains its value and you will also
        aid to a good cause.
      </p>
      <div className="roadmap-row">
        <img src="/curve1.png" alt="" />
        <div className="rb-wrapper">
          <div className="roadmap-circle rc1">
            <div className="phase">
              <p>Phase</p>
              <span>1</span>
            </div>
          </div>
          <div className="roadmap-box rb1">
            <h2>0% The journey begins, welcome to the Nippleverse</h2>
            <ul>
              <li>
              ...
              <li>-1ETH giveaway to the first 100buyers</li>
            </ul>
          </div>
        </div>
        <div className="rb-wrapper">
          <div className="roadmap-circle rc2">
            <div className="phase">
              <p>Phase</p>
              <span>2</span>
            </div>
          </div>
          <div className="roadmap-box rb2">
            <h2>25%-Expanding the Nipplevers</h2>
            <ul>
              ...
              <li>
                there will be a weekly contest where the community can vote the
                best looking nipple, winners will be displayed in a special
                gallery named &apos;&apos;Beauty lays in the nipple of the
                beholder&apos;&apos;.
              </li>
            </ul>
          </div>
        ...
        <div className="rb-wrapper">
          <div className="roadmap-circle rc3">
            <div className="phase">
              <p>Phase</p>
              <span>1</span>
            </div>
          </div>
          <div className="roadmap-box rb3">
            <h2>50%- 4th Wall break</h2>
            <ul>
      ...
      <div className="roadmap-row roadmap-row-last">
        <img src="/curve2.png" alt="" />
        <div className="rb-wrapper">
          <div className="roadmap-circle rc4">
            <div className="phase">
              <p>Phase</p>
              <span>4</span>
            </div>
          </div>
          <div className="roadmap-box rb4">
            <h2>75%-Vincent van Nipple</h2>
            <ul>
              <li>
              ...
              <li>
                -Nipples worth 50000$ will be bought and burned to lift the
                floor price
              </li>
            </ul>
          </div>
        ...
        <div className="rb-wrapper">
          <div className="roadmap-circle rc5">
            <div className="phase">
              <p>Phase</p>
              <span>5</span>
            </div>
          </div>
          <div className="roadmap-box rb5">
            <h2>100%-The ETHernal nippleverse</h2>
            <ul>
              <li>
